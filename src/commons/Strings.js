...
const strings = {
    en: {
        ...
        passWord: 'Password',
        login: 'Sign In',
        descriptionLoginForm: 'By signing up, I agree to SC Vietnam ',
        and: ' and ',
        ...
        contenSpecialOfferScreen: "SC always brings you new, special, attractive and exciting promotions, from Monthly Promotions, Cheap Prices to daily meals that you can't miss.",
